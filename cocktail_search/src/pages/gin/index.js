            ...
            <div className="white-banner" style={{
                ...
                <div style={{
                    ...
                    <p style={{
                        ...
                        ジントニックはジンとトニックウォーターを組み合わせたシンプルで爽快なカクテルです。炭酸の爽快感とジンの香りが特徴で、多くの人に親しまれています。
                    </p>
                </div>
                ...
                <div style={{
                    ...
                    <p><strong>材料:</strong> ジン, トニックウォーター(割合 1:3~4), ライム</p>
                    <p><strong>作り方:</strong> グラスに氷を入れ、ジンとトニックウォーターを注ぎ、ライムを加えます。</p>
                </div>
            </div>

            <div className="gin-page" style={{ position: "relative", zIndex: "5", textAlign: "center" }}>
